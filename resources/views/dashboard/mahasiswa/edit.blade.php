...
<head>
    ...
    <title>Edit Mahasiswa - My Schuder</title>
...
<body>
    ...
    <main class="main-content" id="mainContent">
        ...
        <section class="card" style="max-width: 800px; margin: 0 auto;">
            <div class="card-body">
                <form action="{{ route('administrator.mahasiswa.update', $mahasiswa->id) }}" method="POST">
                    @csrf @method('PUT')
                    ...
                    <div class="form-group" style="margin-bottom: 1.5rem;">
                        ...
                        <input type="text" name="nim" value="{{ old('field', $mahasiswa->field) }}" required
